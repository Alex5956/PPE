...
/*    public void InsertCatego(String Code, String Desig) {
        try{
            
            connexionect();
            PreparedStatement Stt = connexion.prepareStatement("SELECT 'Nom', 'Longueur', 'Largeur' from 'bateau'");
            Stt.executeUpdate();
            Stt.close();
    ...
    public void DeleteCatego(String code){
        try{
            
            connexionect();
            PreparedStatement Stt = connexion.prepareStatement("DELETE FROM `categorie` WHERE code=?");
            Stt.setString(1,code);
            Stt.executeUpdate();
            Stt.close();
            System.out.println("Requete executer");
     ...
     public ResultSet AfficherCatego(){
        try{
            ...
            while(je.next()){
                contenu = "id : " + je.getString(1) + " nom : " + je.getString(2) + " long : " + je.getString(3) + " larg : " + je.getString(4);
